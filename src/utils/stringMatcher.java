...
//                    System.out.println(adjustedBpAtRead[0] + " " + adjustedBpAtRead[1]);
                    ...
                    if (superitem.getWeight() < 5 || superitem.getNumMinusRead() == 0 || superitem.getNumPlusRead() == 0){
                        continue;
                    }
...
//        int levelTwoMinusMatch = newMinusPosList.get(2).size();
    ...
    public void patternGrowth(List<String> mStrings, List<String> sForwardStrings, List<String> sReverseStrings){
